...
public class NormalizedProjectRevisionSAMLProvider {
  ...
  public NormalizedProjectRevisionSAMLProvider validTo(List<String> validTo) {
    this.validTo = validTo;
    return this;
  }

  public NormalizedProjectRevisionSAMLProvider addValidToItem(String validToItem) {
    if (this.validTo == null) {
      this.validTo = new ArrayList<>();
    }
    this.validTo.add(validToItem);
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audienceOverrideBaseUrl, createdAt, id, label, mapperUrl, organizationId, projectRevisionId, providerId, proxyAcsUrl, proxySamlAudienceOverride, rawIdpMetadataXml, state, updatedAt, validTo, additionalProperties);
  }
