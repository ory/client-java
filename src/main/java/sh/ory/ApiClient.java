...
public class ApiClient {
    ...
    private String basePath = "https://.projects.oryapis.com";
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        put("project", new ServerVariable(
          "Your Ory Network Project slug. You can find it in the [Ory Network Console](https://console.ory.sh/projects/current/developers/guides).",
          "playground",
          new HashSet<String>(
          )
        ));
    ...
    public ApiClient() {
        ...
        authentications.put("oryWorkspaceApiKey", new HttpBearerAuth("bearer"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.13.5/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://.projects.oryapis.com
