...
- API version: v0.0.1-alpha.11
  - Build date: 2021-07-07T09:16:24.404833525Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.11</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.11"
```
...
* `target/client-v0.0.1-alpha.11.jar`
* `target/lib/*.jar`
