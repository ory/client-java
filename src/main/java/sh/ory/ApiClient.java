...
public class ApiClient {
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        put("project_slug", new ServerVariable(
          "Your Ory Network Project slug. You can find it in the [Ory Network Console](https://console.ory.sh/projects/current/get-started).",
          "playground",
          new HashSet<String>(
          )
        ));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.22.13/java");
