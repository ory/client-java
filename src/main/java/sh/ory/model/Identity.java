...
public class Identity {
  ...
  public Identity externalId(String externalId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, credentials, externalId, id, metadataAdmin, metadataPublic, organizationId, recoveryAddresses, schemaId, schemaUrl, state, stateChangedAt, traits, updatedAt, verifiableAddresses, additionalProperties);
  }
