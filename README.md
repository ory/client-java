...
- API version: v0.0.1-alpha.12
  - Build date: 2021-07-07T09:24:13.229894274Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.12</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.12"
```
...
* `target/client-v0.0.1-alpha.12.jar`
* `target/lib/*.jar`
