...
public class NormalizedProjectRevisionSAMLProvider {
  public static final String SERIALIZED_NAME_AUDIENCE_OVERRIDE_BASE_URL = "audience_override_base_url";
  @SerializedName(SERIALIZED_NAME_AUDIENCE_OVERRIDE_BASE_URL)
  private String audienceOverrideBaseUrl;
  ...
  public NormalizedProjectRevisionSAMLProvider audienceOverrideBaseUrl(String audienceOverrideBaseUrl) {
    this.audienceOverrideBaseUrl = audienceOverrideBaseUrl;
    return this;
  }

  /**
   * Get audienceOverrideBaseUrl
   * @return audienceOverrideBaseUrl
   */
  @javax.annotation.Nullable
  public String getAudienceOverrideBaseUrl() {
    return audienceOverrideBaseUrl;
  }

  public void setAudienceOverrideBaseUrl(String audienceOverrideBaseUrl) {
    this.audienceOverrideBaseUrl = audienceOverrideBaseUrl;
  }
  ...
  public NormalizedProjectRevisionSAMLProvider proxyAcsUrl(String proxyAcsUrl) {
  ...
  public NormalizedProjectRevisionSAMLProvider proxySamlAudienceOverride(String proxySamlAudienceOverride) {
    this.proxySamlAudienceOverride = proxySamlAudienceOverride;
    return this;
  }

  /**
   * Get proxySamlAudienceOverride
  ...
  public NormalizedProjectRevisionSAMLProvider updateIdentityOnLogin(UpdateIdentityOnLoginEnum updateIdentityOnLogin) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.audienceOverrideBaseUrl, normalizedProjectRevisionSAMLProvider.audienceOverrideBaseUrl) &&
        ...
        Objects.equals(this.proxyAcsUrl, normalizedProjectRevisionSAMLProvider.proxyAcsUrl) &&
        Objects.equals(this.proxySamlAudienceOverride, normalizedProjectRevisionSAMLProvider.proxySamlAudienceOverride) &&
        ...
        Objects.equals(this.updateIdentityOnLogin, normalizedProjectRevisionSAMLProvider.updateIdentityOnLogin) &&
        Objects.equals(this.updatedAt, normalizedProjectRevisionSAMLProvider.updatedAt) &&
        Objects.equals(this.validTo, normalizedProjectRevisionSAMLProvider.validTo)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audienceOverrideBaseUrl, createdAt, id, label, mapperUrl, organizationId, projectRevisionId, providerId, proxyAcsUrl, proxySamlAudienceOverride, rawIdpMetadataXml, state, updateIdentityOnLogin, updatedAt, validTo, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    audienceOverrideBaseUrl: ").append(toIndentedString(audienceOverrideBaseUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("audience_override_base_url");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("audience_override_base_url") != null && !jsonObj.get("audience_override_base_url").isJsonNull()) && !jsonObj.get("audience_override_base_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `audience_override_base_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("audience_override_base_url").toString()));
      }
      ...
      if (jsonObj.get("valid_to") != null && !jsonObj.get("valid_to").isJsonNull() && !jsonObj.get("valid_to").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `valid_to` to be an array in the JSON string but got `%s`", jsonObj.get("valid_to").toString()));
      }
  }
