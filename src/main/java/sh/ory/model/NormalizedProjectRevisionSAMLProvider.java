...
public class NormalizedProjectRevisionSAMLProvider {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audienceOverrideBaseUrl, createdAt, id, label, mapperUrl, organizationId, projectRevisionId, providerId, rawIdpMetadataXml, state, updatedAt, additionalProperties);
  }
