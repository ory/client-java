...
- API version: v0.0.1-alpha.14
  - Build date: 2021-07-07T10:27:17.267939776Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.14</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.14"
```
...
* `target/client-v0.0.1-alpha.14.jar`
* `target/lib/*.jar`
