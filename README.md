...
- API version: v0.0.1-alpha.13
  - Build date: 2021-07-07T09:47:48.213157439Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.13</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.13"
```
...
* `target/client-v0.0.1-alpha.13.jar`
* `target/lib/*.jar`
